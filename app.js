...
$('.results img').click(function(){
        ...
        google.maps.event.addListener(marker, 'click', function() {
            ...
            infowindow.setContent('<div id="infodiv" style="width: 300px"><img class="windowPic" margin-right="10px" float="left" align="left" height="90px" width="90px" src="'+this.photo+'"> <div class="windowName"> '+ this.name +' </div> <div class="windowLocation"> '+this.location+' </div></div>');
            }
