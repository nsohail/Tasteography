...
function callback(results, status){
    ...
    for(var i = 0; i < results.length; i++){
        ...
        if((!photoForPlace) || (photoForPlace === undefined)){ //if there are no pics
            ...
            $('.results').append("<li value ='"+i+"' data-id = '"+results[i].place_id+"'><div class='food-thumbnail'><img style='height:190px;min-width: 230px;' value = '"+i+"' src='"+photoForPlace+"'></div><div class='resultName'>"+placeName+"</div><div class='icon'><img src='https://cdn2.iconfinder.com/data/icons/freecns-cumulus/16/519580-076_LocationArrow-512.png' style='width:10px; margin-right: 10px;'></div><div class='location'>City Not Available</div></li>");
        }
