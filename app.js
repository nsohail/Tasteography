...
$('.results img').click(function(){
        ...
        google.maps.event.addListener(marker, 'click', function() {
            ...
            infowindow.setContent('<div id="infodiv" style="width: 300px"><img class="windowPic" margin-right="10px" float="left" align="left" height="150px" src="http://www.uwplatt.edu/files/styles/high_resolution/public/image_fields/directory_image/image-not-available_1.jpg?itok=GIB8RUHy"> <div class="windowName"> '+ this.name +' </div> <div class="windowLocation"> '+this.location+' </div></div>');
            }else{
            infowindow.setContent('<div id="infodiv" style="width: 300px"><img class="windowPic" margin-right="10px" float="left" align="left" height="150px" src="'+this.photo+'"> <div class="windowName"> '+ this.name +' </div> <div class="windowLocation"> '+this.location+' </div></div>');
            }
